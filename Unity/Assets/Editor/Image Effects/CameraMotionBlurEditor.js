...
{	
  ...
  //var dynamicLayers : SerializedProperty;
	...
	//ISSUE: get error I can't fix, currently muted
  ...
  function OnInspectorGUI () {         
    ...
    //ISSUE: get error I can't fix, currently muted
    //EditorGUILayout.PropertyField ( CameraMotionBlur.preview, new GUIContent("Preview"));
    //if ( CameraMotionBlur.preview.boolValue)
